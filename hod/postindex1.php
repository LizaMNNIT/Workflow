...
for($i=0;$i<$data['total_data_rows'];$i++)
{
  ...
  //  $co = $data['data']["$i"]['leave_type'];
    ...
    echo "<input id=\"fwd_$app_no\" type=\"button\" onclick=\"javascript:forward(this.id);\" value=\"Forward\">;
   // echo "<input id=\"vie_$app_no\" type=\"button\" onclick=\"javascript:view(this.id);\" value=\"View\">";</td></tr>";
}
<
?>
</tbody>
